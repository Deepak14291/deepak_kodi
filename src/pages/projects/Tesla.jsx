            ...
            <div className="mb-10 pb-10">
                ...
                <div className="mt-4 grid grid-cols-12">
                    <div className="col-start-2 col-end-7 col-span-5 mulish-font text-sm leading-relaxed font-bold">
                        LIVE <span className="text-[#0166B1] ml-2 font-extrabold"><a target="_blank" href="https://deepak14291.github.io/tesla/">View
                            Site</a></span>
                    </div>
                </div>
                ...
                <div className="mt-4 grid grid-cols-12">
                    <div className="col-start-2 col-end-11 col-span-9">
                        <img src="/assets/images/project_images/tesla/tesla-homepage.png" alt="" />
                    </div>
                </div>
                ...
                <div className="mt-4 grid grid-cols-12">
                    <div className="col-start-2 col-end-11 col-span-9">
                        <img src="/assets/images/project_images/tesla/tesla-screen2.png" alt="" />
                    </div>
                </div>
                <div className="mt-6 grid grid-cols-12 mulish-font text-sm leading-relaxed font-semibold">
                    <div className="col-start-2 col-end-9 col-span-7">
                ...
                <div className="mt-4 grid grid-cols-12">
                    <div className="col-start-2 col-end-11 col-span-9">
                        <img src="/assets/images/project_images/tesla/tesla-screen3.png" alt="" />
                    </div>
                </div>
                ...
                <div className="mt-10">
                    <div className="grid grid-cols-12 mulish-font">
                        <div className="col-start-2 col-end-6 col-span-4 ">
                            <img src="/assets/images/project_images/mazda/mazda-thumbnail.png" alt="" width="400" height="400" />
                            <div className="mt-4 font-extrabold text-2xl">Mazda</div>
                            ...
                            <div className="mt-4 font-bold text-sm">
                                <Link to="mazda">VIEW PROJECT</Link>
                            </div>
                        </div>
